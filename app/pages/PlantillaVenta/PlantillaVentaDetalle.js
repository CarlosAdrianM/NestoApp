...
var PlantillaVentaDetalle = (function () {
    function PlantillaVentaDetalle(servicio, nav, navParams) {
        this.nav = nav;
    ...
    PlantillaVentaDetalle.prototype.comprobarSiExisteElProducto = function (producto) {
        var _this = this;
    ...
    PlantillaVentaDetalle = __decorate([
        ...
        __metadata('design:paramtypes', [PlantillaVenta_service_1.PlantillaVentaService, ionic_angular_1.NavController, ionic_angular_1.NavParams])
    ], PlantillaVentaDetalle);
    return PlantillaVentaDetalle;
})();
exports.PlantillaVentaDetalle = PlantillaVentaDetalle;
