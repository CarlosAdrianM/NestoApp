...
var PlantillaVenta = /** @class */ (function () {
    ...
    PlantillaVenta.prototype.ionViewDidEnter = function () {
        var _this = this;
        if (this.slider.getActiveIndex() === 0) {
            setTimeout(function () {
                _this.mySelectorCliente.setFocus();
            }, 0);
        }
        else if (this.slider.getActiveIndex() === 1) {
            setTimeout(function () {
                _this._selectorPlantillaVenta.setFocus();
            }, 0);
        }
    };
    ...
    ], PlantillaVenta.prototype, "mySelectorCliente", void 0);
    __decorate([
