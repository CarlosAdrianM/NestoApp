...
var ListaRapportsService = /** @class */ (function () {
    function ListaRapportsService(http, usuario) {
    ...
    ListaRapportsService.prototype.handleError = function (error) {
        // in a real world app, we may send the error to some remote logging infrastructure
        // instead of just logging it to the console
        console.error(error);
        return Observable.throw(error.json().error || 'Server error');
    };
    ListaRapportsService = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [Http, Usuario])
    ], ListaRapportsService);
    return ListaRapportsService;
}());
export { ListaRapportsService };
//# sourceMappingURL=ListaRapports.service.js.map