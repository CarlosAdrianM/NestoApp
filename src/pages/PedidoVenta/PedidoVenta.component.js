...
var PedidoVentaComponent = /** @class */ (function () {
    ...
    PedidoVentaComponent.prototype.cargarPedido = function (empresa, numero) {
        ...
        this.servicio.cargarPedido(empresa, numero).subscribe(function (data) {
            ...
            var textoError = 'No se ha podido cargar el pedido de la empresa ' + empresa + ".\n" + error.ExceptionMessage;
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        ...
                        _this.servicio.modificarPedido(_this.pedido).subscribe(function (data) {
                            ...
                            var textoError = 'No se ha podido modificar el pedido.\n' + error.ExceptionMessage;
                            var innerException = error.InnerException;
                            while (innerException != null) {
                                textoError += '\n' + innerException.ExceptionMessage;
                                innerException = innerException.InnerException;
