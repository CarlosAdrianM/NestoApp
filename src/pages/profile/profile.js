...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(http, usuario, nav, loadingCtrl, local, parametros, fcm, alertCtrl) {
    ...
    ProfilePage = __decorate([
        ...
        __metadata("design:paramtypes", [Http, Usuario, NavController, LoadingController, Storage, Parametros, FCM, AlertController])
    ], ProfilePage);
    return ProfilePage;
}());
export { ProfilePage };
