...
var SelectorPlantillaVenta = /** @class */ (function (_super) {
    __extends(SelectorPlantillaVenta, _super);
    function SelectorPlantillaVenta(servicio, alertCtrl, loadingCtrl, nav, keyboard) {
    ...
    */
    SelectorPlantillaVenta.prototype.setFocus = function () {
        var _this = this;
        setTimeout(function () {
            _this.myProductoSearchBar.setFocus();
            _this.keyboard.show();
        }, 1500);
    };
    ...
    __decorate([
        ViewChild('filtro'),
        __metadata("design:type", Object)
    ], SelectorPlantillaVenta.prototype, "myProductoSearchBar", void 0);
    SelectorPlantillaVenta = __decorate([
        Component({
            selector: 'selector-plantilla-venta',
            templateUrl: 'SelectorPlantillaVenta.html',
        }),
        __metadata("design:paramtypes", [SelectorPlantillaVentaService, AlertController, LoadingController, NavController, Keyboard])
